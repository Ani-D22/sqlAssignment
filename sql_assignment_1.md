...
SELECT
	...
	SUM(DISTINCT O.GRAND_TOTAL) AS TOTAL_REVENUE
FROM
	ORDER_HEADER O
JOIN ORDER_ITEM_SHIP_GROUP OISG
    ON
	OISG.ORDER_ID = O.ORDER_ID
...
WHERE
	O.ORDER_DATE
        BETWEEN '2024-12-01 00:00:00'
            AND '2024-12-31 23:59:59'
	AND O.STATUS_ID = 'ORDER_CANCELLED'
GROUP BY
	OS.CHANGE_REASON;
```
